...
public class Bicicleta {
    ...
    public static String rutaCorta(int [] camino1, int [] camino2, int [] camino3)
    {
        ...
        /*la solución es añadir dos bucles 
        for más ,para evaluar cada parametro 
        (ántes sólo evaluaba el camino1)*/
        for(int i=0; i<camino1.length; i++)
        {
            ...
            for(int k=0;k<camino3.length;k++)
          {
            ...
            return solucion(sum1,sum2,sum3);
          }
            
        
     public static String solucion(int sum1, int sum2,int sum3) /*metodo que evalua longitudes y devuelve la más pequeña*/
     {
